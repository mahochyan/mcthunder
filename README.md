...
原创体素／低模方块视觉的坦克战斗原型。总体目标是尽可能还原战争雷霆式陆战玩法；完整路线见 [开发计划](docs/handoff/DEVELOPMENT_007_036.md)。当前开发版已实现装甲结算、内部损伤、弹药账本、火灾与维修/乘员替补。真实路径回放、中文车库/实际配弹/核心训练结果流程已可用；AI与完整比赛仍按依赖推进；计划不是已完成内容。
