...
当前接续版 **0.2.7** 位于 `E:/AIprogram/mcthunder-mainline`，双击本目录 `START_GAME.bat`。已接入集中中文文本、键盘菜单导航、车库声音与显示设置、制作许可和退出确认。主线继续从稳定化分支推进，详情与剩余项见 [027 接续记录](docs/IMPLEMENTATION_027_CONTINUATION.md)。
