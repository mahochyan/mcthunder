...
## 自检
- 无窗口自动检查 **78 项全部通过**（001 的 52 项全保留 + 002/002-R1 新增回归：
  空格路径启动 / 三遮挡场景 / 暂停持火与失焦 / 相机俯仰一致 / 真实按钮点击 /
  连续 20 次重置 / 变异验证），原始记录：`logs/002/`、`logs/002-R1/`
- 真实窗口截图（720p + 1080p，含暂停菜单）：`docs/autoshot_*.png`
- 交付记录：`docs/DELIVERY_001.md`、`docs/DELIVERY_002.md`、`docs/DELIVERY_002_R1.md`、
