param(
    [string[]]$Suites = @('run_checks','run_layout_checks','run_query_checks','run_projectile_checks','run_armor_checks','run_damage_checks','run_recovery_checks','run_replay_checks','run_core_checks','run_drive_checks','run_ai_drive_checks','run_ai_combat_checks','run_duel_checks','run_team_checks'),
...
foreach ($suite in $Suites) {
    $simulationClock = if ($suite -in @('run_ai_drive_checks','run_ai_combat_checks','run_duel_checks','run_team_checks')) { ' --fixed-fps 60' } else { '' }
