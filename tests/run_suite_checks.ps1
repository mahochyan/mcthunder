...
foreach ($suite in $Suites) {
    ...
    if ($suite -in @('run_modern_support_checks','run_modern_armor_frame_checks','run_modern_garage_checks','run_engineering_runtime_checks','run_engineering_damage_checks')) { $simulationClock = ' --fixed-fps 60' }
