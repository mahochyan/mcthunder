...
for d in specs:
 ...
 arcade_tuning=dict(resolution_state='arcade_design_fallback',base_acceleration_mps2=d['accel'],arcade_power_multiplier_applied=1.0,source_field=None,source_value=None,note='No authorized War Thunder arcade cache row is available for this legacy vehicle; current project arcade tuning is explicit and makes no historical/full-real claim.')
