...
func frame(tick: int, x: float, yaw: float, life: int=1) -> Dictionary:
	...
	return {"version":VehicleFramePose.NETWORK_VERSION,"tick":tick,"sequence":tick,"vehicles":[{"entity_id":"A","life_id":life,"generation":1,"control_epoch":1,"position":[x,0,0],"yaw":yaw,"turret_yaw":yaw,"gun_pitch":0,"frame_pose":relative,"destroyed":false}]}
