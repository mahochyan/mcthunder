...
用户已明确要求按接手计划完成后续开发，目标为体素/低模方块视觉、尽可能还原战争雷霆陆战内容。
用户补充：体素不意味着省略外表，外形尽可能贴近原型；执行 `docs/MODELING_STANDARD.md`，保留比例、装甲轮廓、炮塔炮盾、悬挂履带和外部附件。
当前从 006 的 3a9326d 起继续 007—036，工程自审通过后按依赖连续推进；不再逐单等旧模型签收。
权威接手计划见 docs/handoff/DEVELOPMENT_007_036.md；007 方案见 docs/IMPLEMENTATION_007.md。
历史签收、真人状态与工程自审分别保存；不代签真人，不默认合并 main、付费或公开发布。
下方“007未授权”“每单完成即停”等仅为历史协议，不再限制本轮明确授权范围。
