...
const COMMAND_MAX_AGE_TICKS := 12 # Local contract window; not a network lag-compensation promise.
...
const DRIVE_SUPPORT_REACH_M := 0.55 # Effective track support reach; game tuning.
