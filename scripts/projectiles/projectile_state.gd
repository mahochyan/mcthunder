...
var post_penetration_profile: Dictionary = {}
var spall_events: Array[Dictionary] = []
var spall_surfaces: Dictionary = {}
var chemical_profile: Dictionary = {}
var chemical_effect: Dictionary = {}
var caliber_mm := 0.0
