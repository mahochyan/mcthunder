...
const REPAIR_PRIORITY := ["track","breech","engine","transmission","turret_drive","turret_horizontal_drive","turret_vertical_drive","stabilizer","autoloader","ammo_partition","ammo","blowout_panel"]
