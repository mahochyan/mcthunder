...
当前代码从稳定候选继续至 `codex/mainline-027-continuation`，工作树 `E:/AIprogram/mcthunder-mainline`，生产源码 caa4191。027 中文与主流程已补齐一轮：279 项相关回归、两种精确分辨率各 30 项真实窗口检查、独立 PCK 资源检查通过。见 `DELIVERY_027_CONTINUATION.md`。下一项是 030 完整产品流程；31—36 与整局性能/真人验收仍未完成。下文保留原稳定化阶段记录。
