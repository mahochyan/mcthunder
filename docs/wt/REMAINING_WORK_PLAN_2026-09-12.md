...
2026-09-12；核对源码基线 `5f24ae6`。本轮按用户要求先规划全部未完成工作，尚未继续测距实现。游戏总目标保持完整陆战、现代对抗、空地、独立空海和持续维护。
...
- 当前样车默认M4A3/M24；核心地图默认先精修丘陵村落，工业边缘作差异地图及回归。现代沿WT-027先M1A1族，具体改型与装备必须先核对，展厅名称不能代替资料证明。
- 待冻结的产品决策：首发年代/双方阵营/逐车名单、规则预设、三图尺度、目标硬件与画质/LOD预算、成长成本、支持平台/房间环境。先按上述路线开展必要本地工作，到影响具体交付的门前再冻结，不凭空编出“已批准”的名单或日历工期。
- 规划采用两阵营约8—12车、3图和8v8首版目标；这些是待验证的内容/容量目标。首发不能为凑数混入不具备完整装备或年代悬殊的车。
- 公开部署、商店提交、收费/购买服务在成果可审阅后按实际需求另行取得授权；不妨碍本地代码、离线包和本机网络验证。
- 本轮只交付完整规划，后续恢复开发从WT-007B开始。没有把这份计划的完成当作完整游戏目标已完成。
...
**剩余工作：** 沿现有工单先做M1A1族现代样车，冻结确切改型；接稳定/测距/热像/弹族/防护/乘员弹架与火控损伤。
...
**剩余工作：** 研究确切对手改型，验证现代距离/节奏/反制，冻结首发年代、双方阵营和角色覆盖。
