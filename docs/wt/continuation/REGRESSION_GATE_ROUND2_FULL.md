# 回归门报告 · 第 2 轮（**回归门 RG-2**）· **完整版**

> **编号更正（2026-09-13，自我更正）**：本门最初被标为 `WT-035-R1`，属**编号错用**——材料 03 的 **WT-035 是「主界面、战斗HUD与新手教学」**，而「性能、回归与长时稳定」属 **WT-036**。因此本门应计为 **WT-036-R1 的回归部分**；历史提交信息里的 `WT-035-R1` 字样**保留不改写**（不重写历史），以本文件与 `NEXT_ACTION` 作为更正的权威记录。**不得**以本门充当 WT-035 的交付。
