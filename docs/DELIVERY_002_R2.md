...
### 002-R3 勘误（提交号说明，GPT 审核指出）

"证据 SHA 与代码 SHA 相同"的表述不准确：**证据目录名用源码 SHA 命名，但目录名不等于
存储证据的提交号**。实际提交链：

| 用途 | 提交 |
|---|---|
| 被测源码 | `96f199b8eb140bb1c2e644bd35b61f0fe3492155` |
| 截图、清单与交付文档 | `b6eec1ce11485608fe0fc18659395cba67dad0a7` |
| 最终回归日志与交付 HEAD | `db24e439109f4fdaed2f5509620fe489ac872a98` |

证据目录 `docs/evidence/002-R2/96f199b…/` 中的"96f199b…"是**被测源码 SHA**（证据归属），
证据文件本身存储在 b6eec1c 提交中。002-R3 起沿用同一约定并在交付中同时给出
源码 SHA、证据提交号与交付 HEAD。
